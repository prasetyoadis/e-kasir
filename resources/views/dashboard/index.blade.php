...
<body>
    <div id="dashboard" class="" style="max-width: 480px; margin: 0 auto;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:16px">
            ...
            <div id="inventory" class="box" style="display: none; align-items: center; justify-content: center; width:100px; height:100px; text-align: center; color:white; background:orange">Products</div>
